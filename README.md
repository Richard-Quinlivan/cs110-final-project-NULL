...
|  13  | Game Over Menu | 1) If the hero ship loses all three lives the game over menu opens normally and is functional
2) A game over sound effect should begin playing normally |          |
